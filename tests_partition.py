...
class TestGraphBehavior(unittest.TestCase):
    ...
    def test_node_update(self):
        self.GRT.nodes.update(key="1", properties="1")
        self.assertEqual(self.GRT.nodes.get(key="1").properties, "1")
    ...
    def test_edge_create(self):
        self.GRT.edges.create(source="0", target="11", properties="1")
        self.assertEqual(self.GRT.edges.get(source="0", target="11").properties, "1")
        self.GRT.edges.create(source="1", target="2", properties="1")
        self.assertEqual(self.GRT.edges.get(source="1", target="2").properties, "1")
        self.GRT.edges.create(source="2", target="1", properties="1")
        self.assertEqual(self.GRT.edges.get(source="2", target="1").properties, "1")
    ...
    def test_edge_get(self):
        ...
        self.assertIsNone(self.GRT.edges.get(source="5", target="1"))
    ...
    def test_edge_deletion(self):
        self.GRT.edges.delete(source="1", target="2")
        self.assertIsNone(self.GRT.edges.get(source="1", target="2"))
